#This portion covers the concepts of R basics, daat visualisation in R, data preparation in R and  univariate statistics
...
a=1:26
b=LETTERS
paste(a,b,sep=":",collapse = "-") #concatinating with a separator and a collapse param thatwould be added 
...
#Sequence function
seq(1,5)
#Icreasing the values in a sequence by a specific interval
seq(1,5,by=0.5)
...
names(df2)[c(1,2)] #toget specifc colnames
...
#Accessing series if rows and cols
df2[c(1:3),c(1:3)]
